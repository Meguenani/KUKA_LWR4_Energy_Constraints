...
ploted_q_dotdotdot_3,          = plt.plot(0.001*np.arange(0,np.size(q_dotdotdot_3),1),          q_dotdotdot_3,          "b",   linewidth=2.0)
ploted_q_dotdotdot_3_max,      = plt.plot(0.001*np.arange(0,np.size(q_dotdotdot_3_max),1),      q_dotdotdot_3_max,      "r",   linewidth=2.0)
ploted_q_dotdotdot_3_min,      = plt.plot(0.001*np.arange(0,np.size(q_dotdotdot_3_min),1),      q_dotdotdot_3_min,      "r--",   linewidth=2.0)
plt.legend([ploted_q_dotdotdot_3, ploted_q_dotdotdot_3_max, ploted_q_dotdotdot_3_min], ['$\dddot{q}_3 (rad/s^3)$', '$\dddot{q_{0_{max}}} (rad/s^3)$', '$\dddot{q_{0_{min}}} (rad/s^3)$'])

plt.xlabel("$time (s)$", fontsize=20)
plt.axis([0,0.001*np.size(q_dotdotdot_3), -8000, 8000])
...
plt.xlabel("$time (s)$", fontsize=20)
plt.axis([0,0.001*np.size(q_dotdotdot_3), -2000, 2000])
plt.ticklabel_format(useOffset=False)
plt.grid(True)
############################q_dot_dot_dot plot##############################
...
ploted_q_3,                    = plt.plot(0.001*np.arange(0,np.size(q_3),1),                    q_3,                    "b",   linewidth=2.0)
ploted_q_3_max,                = plt.plot(0.001*np.arange(0,np.size(q_3_max),1),                q_3_max,                "r",   linewidth=2.0)
ploted_q_3_min,                = plt.plot(0.001*np.arange(0,np.size(q_3_min),1),                q_3_min,                "r--",   linewidth=2.0)



plt.legend([ploted_q_3, ploted_q_3_max, ploted_q_3_min], ['$q_3 (rad)$', '$q_{0_{max}} (rad)$', '$q_{0_{min}} (rad)$'])

plt.xlabel("$time (s)$", fontsize=20)
plt.axis([0,0.001*np.size(q_3), -3.5, 3.5])
plt.ticklabel_format(useOffset=False)
plt.grid(True)
############################q_dot_dot plot_comp FINAL DEBUG##############################
...
ploted_q_dot_3,          = plt.plot(0.001*np.arange(0,np.size(q_dot_3),1),          q_dot_3,          "b",   linewidth=2.0)
ploted_q_dot_3_max,      = plt.plot(0.001*np.arange(0,np.size(q_dot_3_max),1),      q_dot_3_max,      "r",   linewidth=2.0)
ploted_q_dot_3_min,      = plt.plot(0.001*np.arange(0,np.size(q_dot_3_min),1),      q_dot_3_min,      "r--",   linewidth=2.0)

plt.legend([ploted_q_dot_3, ploted_q_dot_3_max, ploted_q_dot_3_min], ['$\dot{q}_3 (rad/s)$', '$\dot{q}_{0_{min}} (rad/s)$', '$\dot{q}_{0_{min}} (rad/s)$'])
plt.xlabel("$time (s)$", fontsize=20)
plt.axis([0,0.001*np.size(q_dot_3), -4, 4])
plt.ticklabel_format(useOffset=False)
plt.grid(True)
#############################compatibility q_dot-q_dddot0 plot##############################
...
ploted_q_dotdot_3,                      = plt.plot(0.001*np.arange(0,np.size(q_dotdot_3),1),                      q_dotdot_3,                   "b",   linewidth=2.0)
ploted_q_dotdot_3_max_comp,             = plt.plot(0.001*np.arange(0,np.size(q_dotdot_3_max_comp),1),             q_dotdot_3_max_comp,          "r",   linewidth=2.0)
ploted_q_dotdot_3_min_comp,             = plt.plot(0.001*np.arange(0,np.size(q_dotdot_3_min_comp),1),             q_dotdot_3_min_comp,          "r--",   linewidth=2.0)



plt.legend([ploted_q_dotdot_3, ploted_q_dotdot_3_max_comp, ploted_q_dotdot_3_min_comp], ['$\ddot{q}_3 (rad s^2)$', '$\ddot{q}_{0_{max}} (rad s^2)$', '$\ddot{q}_{0_{min}} (rad s^2)$'])


plt.xlabel("$time (s)$", fontsize=20)
plt.axis([0,0.001*np.size(q_dotdot_3), -100, 100])
plt.ticklabel_format(useOffset=False)
plt.grid(True)
############################q_dot_dot plot_comp##############################
...
ploted_q_dotdot_3,                 = plt.plot(0.001*np.arange(0,np.size(q_dotdot_3),1),                 q_dotdot_3,              "b",   linewidth=2.0)
ploted_q_dotdot_3_max,             = plt.plot(0.001*np.arange(0,np.size(q_dotdot_3_max),1),             q_dotdot_3_max,          "r",   linewidth=2.0)
ploted_q_dotdot_3_min,             = plt.plot(0.001*np.arange(0,np.size(q_dotdot_3_min),1),             q_dotdot_3_min,          "r--",   linewidth=2.0)



plt.legend([ploted_q_dotdot_3, ploted_q_dotdot_3_max, ploted_q_dotdot_3_min], ['$\ddot{q}_3 (rad s^2)$', '$\ddot{q}_{0_{max}} (rad s^2)$', '$\ddot{q}_{0_{min}} (rad s^2)$'])


plt.xlabel("$time (s)$", fontsize=20)
plt.axis([0,0.001*np.size(q_dotdot_3), -1250, 250])
plt.ticklabel_format(useOffset=False)
plt.grid(True)
############################q_dot_dot plot_comp##############################
