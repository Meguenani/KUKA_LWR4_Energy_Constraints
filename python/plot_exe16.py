...
ploted_q_dotdotdot_6,          = plt.plot(0.001*np.arange(0,np.size(q_dotdotdot_6),1),          q_dotdotdot_6,          "b",   linewidth=2.0)
ploted_q_dotdotdot_6_max,      = plt.plot(0.001*np.arange(0,np.size(q_dotdotdot_6_max),1),      q_dotdotdot_6_max,      "r",   linewidth=2.0)
ploted_q_dotdotdot_6_min,      = plt.plot(0.001*np.arange(0,np.size(q_dotdotdot_6_min),1),      q_dotdotdot_6_min,      "r--",   linewidth=2.0)
plt.legend([ploted_q_dotdotdot_6, ploted_q_dotdotdot_6_max, ploted_q_dotdotdot_6_min], ['$\dddot{q}_6 (rad/s^3)$', '$\dddot{q_{0_{max}}} (rad/s^3)$', '$\dddot{q_{0_{min}}} (rad/s^3)$'])

plt.xlabel("$time (s)$", fontsize=20)
plt.axis([0,0.001*np.size(q_dotdotdot_6), -8000, 8000])
...
plt.xlabel("$time (s)$", fontsize=20)
plt.axis([0,0.001*np.size(q_dotdotdot_6), -2000, 2000])
plt.ticklabel_format(useOffset=False)
plt.grid(True)
############################q_dot_dot_dot plot##############################
...
ploted_q_6,                    = plt.plot(0.001*np.arange(0,np.size(q_6),1),                    q_6,                    "b",   linewidth=2.0)
ploted_q_6_max,                = plt.plot(0.001*np.arange(0,np.size(q_6_max),1),                q_6_max,                "r",   linewidth=2.0)
ploted_q_6_min,                = plt.plot(0.001*np.arange(0,np.size(q_6_min),1),                q_6_min,                "r--",   linewidth=2.0)



plt.legend([ploted_q_6, ploted_q_6_max, ploted_q_6_min], ['$q_6 (rad)$', '$q_{0_{max}} (rad)$', '$q_{0_{min}} (rad)$'])

plt.xlabel("$time (s)$", fontsize=20)
plt.axis([0,0.001*np.size(q_6), -3.5, 3.5])
plt.ticklabel_format(useOffset=False)
plt.grid(True)
############################q_dot_dot plot_comp FINAL DEBUG##############################
...
ploted_q_dot_6,          = plt.plot(0.001*np.arange(0,np.size(q_dot_6),1),          q_dot_6,          "b",   linewidth=2.0)
ploted_q_dot_6_max,      = plt.plot(0.001*np.arange(0,np.size(q_dot_6_max),1),      q_dot_6_max,      "r",   linewidth=2.0)
ploted_q_dot_6_min,      = plt.plot(0.001*np.arange(0,np.size(q_dot_6_min),1),      q_dot_6_min,      "r--",   linewidth=2.0)

plt.legend([ploted_q_dot_6, ploted_q_dot_6_max, ploted_q_dot_6_min], ['$\dot{q}_6 (rad/s)$', '$\dot{q}_{0_{min}} (rad/s)$', '$\dot{q}_{0_{min}} (rad/s)$'])
plt.xlabel("$time (s)$", fontsize=20)
plt.axis([0,0.001*np.size(q_dot_6), -4, 4])
plt.ticklabel_format(useOffset=False)
plt.grid(True)
#############################compatibility q_dot-q_dddot0 plot##############################
...
ploted_q_dotdot_6,                      = plt.plot(0.001*np.arange(0,np.size(q_dotdot_6),1),                      q_dotdot_6,                   "b",   linewidth=2.0)
ploted_q_dotdot_6_max_comp,             = plt.plot(0.001*np.arange(0,np.size(q_dotdot_6_max_comp),1),             q_dotdot_6_max_comp,          "r",   linewidth=2.0)
ploted_q_dotdot_6_min_comp,             = plt.plot(0.001*np.arange(0,np.size(q_dotdot_6_min_comp),1),             q_dotdot_6_min_comp,          "r--",   linewidth=2.0)



plt.legend([ploted_q_dotdot_6, ploted_q_dotdot_6_max_comp, ploted_q_dotdot_6_min_comp], ['$\ddot{q}_6 (rad s^2)$', '$\ddot{q}_{0_{max}} (rad s^2)$', '$\ddot{q}_{0_{min}} (rad s^2)$'])


plt.xlabel("$time (s)$", fontsize=20)
plt.axis([0,0.001*np.size(q_dotdot_6), -100, 100])
plt.ticklabel_format(useOffset=False)
plt.grid(True)
############################q_dot_dot plot_comp##############################
...
ploted_q_dotdot_6,                 = plt.plot(0.001*np.arange(0,np.size(q_dotdot_6),1),                 q_dotdot_6,              "b",   linewidth=2.0)
ploted_q_dotdot_6_max,             = plt.plot(0.001*np.arange(0,np.size(q_dotdot_6_max),1),             q_dotdot_6_max,          "r",   linewidth=2.0)
ploted_q_dotdot_6_min,             = plt.plot(0.001*np.arange(0,np.size(q_dotdot_6_min),1),             q_dotdot_6_min,          "r--",   linewidth=2.0)



plt.legend([ploted_q_dotdot_6, ploted_q_dotdot_6_max, ploted_q_dotdot_6_min], ['$\ddot{q}_6 (rad s^2)$', '$\ddot{q}_{0_{max}} (rad s^2)$', '$\ddot{q}_{0_{min}} (rad s^2)$'])


plt.xlabel("$time (s)$", fontsize=20)
plt.axis([0,0.001*np.size(q_dotdot_6), -1250, 250])
plt.ticklabel_format(useOffset=False)
plt.grid(True)
############################q_dot_dot plot_comp##############################
