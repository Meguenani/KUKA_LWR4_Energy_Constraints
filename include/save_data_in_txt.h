...
void save_tau_0_max(double tau_0);
void save_tau_1_max(double tau_1);
void save_tau_2_max(double tau_2);
void save_tau_3_max(double tau_3);
void save_tau_4_max(double tau_4);
void save_tau_5_max(double tau_5);
void save_tau_6_max(double tau_6);




void save_tau_0_min(double tau_0);
void save_tau_1_min(double tau_1);
void save_tau_2_min(double tau_2);
void save_tau_3_min(double tau_3);
void save_tau_4_min(double tau_4);
void save_tau_5_min(double tau_5);
void save_tau_6_min(double tau_6);
...
void save_V_7_prev_0(double V_7_0);
void save_Acc_x_prev(double Acc_x_prev);
...
void save_q_dotdot_des_6(double q_dot_dot_des_6);
void save_q_dotdot_des_5(double q_dot_dot_des_5);
void save_q_dotdot_des_4(double q_dot_dot_des_4);
void save_q_dotdot_des_3(double q_dot_dot_des_3);
void save_q_dotdot_des_2(double q_dot_dot_des_2);
void save_q_dotdot_des_1(double q_dot_dot_des_1);
void save_q_dotdot_des_0(double q_dot_dot_des_0);
...
void save_Real_Ec_7_x_rcnsrcted_wth_small_Ep_7_x(double Real_Ec_7_x_rcnsrcted_wth_small_Ep_7_x);
...
void save_q_dotdot_bounds_min_optimized(Eigen::VectorXd q_dotdot_bounds_min_trq_derived);
void save_q_dotdot_bounds_max_optimized(Eigen::VectorXd q_dotdot_bounds_max_trq_derived);
...
void save_q_dotdotdot_gurobi(Eigen::VectorXd q_dddot_gurobi);
